...
- Textarea with a **maximum character limit (200 characters)**
- Real-time character count update
- Displays **typed / total characters** (e.g., `150 / 200`)
- Warning message when the character limit is reached
- Prevents further typing beyond the limit
...
- **HTML5** – Textarea and layout
- **CSS3** – Basic styling and warning message
